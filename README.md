...
```
So, this is the objective of this project – a space to report on the log analysis method I used, prioritizing the use of the console, preceeded by an executive summary, and the IoCs that I’m trying to look for.
